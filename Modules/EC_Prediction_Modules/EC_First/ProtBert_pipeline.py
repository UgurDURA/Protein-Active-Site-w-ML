...
import numpy as np
import pandas as pd
from transformers import TextClassificationPipeline, AutoTokenizer, TFBertForSequenceClassification
import sys
sys.path.append('../../')
...
bert = TFBertForSequenceClassification.from_pretrained('Rostlab/prot_bert_bfd_localization', from_pt=True)

pipeline = TextClassificationPipeline(model=bert, tokenizer=tokenizer, device=0, framework='tf',)  # TODO: change device to read from cuda api
