    ...
    try:
        ...
        for feature in features:
            ...
            if position is not None and len(feature.attrib['description']) < 40 :
                feature_str = feature.attrib['type'] + ',' + feature.attrib['description'] + ',' + position.attrib['position']
        ...
        print(accesion_string + ', ' + full_name_string + ', '+ ec_numbers_string +', '+ rhea_ids_string +', '+ features_string +', ' + sequence_length +', '+sequence_string)
